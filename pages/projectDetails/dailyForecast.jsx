...
import dForecast from '../../public/assets/projects/simple-js-api-weather-app.jpg';

const dailyForecast = () => {
  return (
    <div className='w-full'>
      <Head>
        <title>Project - Daily Forecast</title>
      </Head>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          ...
          <p className='my-4'>
            A simple weather app using HTML, CSS, and openAPI along with JavaScript.
          </p>
          <a
            href='https://github.com/sfshovon/simple-js-api-weather-app'
            target='_blank'
            rel='noreferrer'
          >
          ...
          <a
            href='https://simple-js-api-weather-app.netlify.app'
            target='_blank'
            rel='noreferrer'
          >
