...
import iStore from '../../public/assets/projects/simple-bootstrap-responsive-project-1.jpg';

const iPhoneStore = () => {
  return (
    <div className='w-full'>
      <Head>
        <title>Project - iPhone Store</title>
      </Head>
      <div className='w-screen h-[50vh] relative'>
        ...
        <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
          <h2 className='py-2'>iPhone Store</h2>
          <h3> Bootstrap </h3>
        </div>
      </div>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          ...
          <p className='my-4'>
            A simple responsive project using HTML, CSS and Bootstrap components.
          </p>
          <a
            href='https://github.com/sfshovon/simple-bootstrap-responsive-project-1'
            target='_blank'
            rel='noreferrer'
          >
          ...
          <a
            href='https://simple-bootstrap-responsive-project-1.netlify.app'
            target='_blank'
            rel='noreferrer'
          >
